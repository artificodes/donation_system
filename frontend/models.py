...
class General(models.Model):
    ...
    primary_image= models.ImageField(blank=False, default ='',)
    secondary_image= models.ImageField(blank=False, default ='',)
    ...
    primary_color = models.CharField(max_length=255, default ='', blank=True, )
    rgba_color = models.CharField(max_length=255, default ='', blank=True, )
    payment_banner = models.ImageField(blank=False, default ='',)
    footer_background = models.ImageField(blank=False, default ='',)
