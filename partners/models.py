...
class DpMembers(models.Model):
    user = models.ForeignKey(User,null=True,on_delete=models.SET_NULL, default='',blank=True,editable=False)
    ...
    call_code = models.CharField(max_length=5, blank=True, null=True)
    ...
    pass_word = models.CharField(max_length=32, blank=True, null=True)
    password_request = models.CharField(max_length=1)
    temp_password = models.CharField(max_length=200, blank=True, null=True)
    phone_no = models.CharField(max_length=45, blank=True, null=True)
    phone_no_alt = models.CharField(max_length=45, blank=True, null=True)
    lra_member = models.CharField(max_length=45, blank=True, null=True)
    ...
    contribution = models.DecimalField(max_digits=20, decimal_places=0, blank=True, null=True)
    start_month = models.CharField(max_length=45, blank=True, null=True)
    start_year = models.CharField(max_length=45, blank=True, null=True)
    start_date = models.DateField(blank=True, null=True)
    status = models.CharField(max_length=1)
    terminated_date = models.DateField(blank=True, null=True)
    spouse_first_name = models.CharField(max_length=45, blank=True, null=True)
    spouse_middle_name = models.CharField(max_length=45, blank=True, null=True)
    spouse_last_name = models.CharField(max_length=45, blank=True, null=True)
    spouse_dob = models.DateField(blank=True, null=True)
    spouse_phone = models.CharField(max_length=45, blank=True, null=True)
    spouse_email = models.CharField(max_length=45, blank=True, null=True)
    ...
    preferred_flg = models.CharField(max_length=1, blank=True, null=True)
    source = models.CharField(max_length=50, blank=True, null=True)
    approval_status = models.CharField(max_length=45, blank=True, null=True)
...
class DpPayments(models.Model):
    ...
    payment_year = models.CharField(max_length=45, blank=True, null=True)

    month_covered = models.DateField(default=now)
    pay_reference = HTMLField(blank=True, null=True)
    description = models.CharField(max_length=2000, blank=True, null=True)
    pay_source = models.CharField(max_length=45, blank=True, null=True)
    del_flg = models.CharField(max_length=1)
    status = models.CharField(max_length=1, blank=True, null=True)
    currency = models.CharField(max_length=3)
    applied_flg = models.CharField(max_length=1)
    member_id = models.IntegerField(blank=True,default=-1)
    member_no = models.CharField(max_length=45, blank=True, null=True)
    ...
    last_modified_on = models.DateField(blank=True, null=True)
